...
class Qwen2_5_Omni_MonoModalChatModel(BaseModel):
    def _generate(self, messages):
        ...
        text_ids = self.model.generate(**inputs, use_audio_in_video=use_audio_in_video, max_new_tokens=self.max_new_tokens)
